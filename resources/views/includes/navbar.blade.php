            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle  {{ request()->is('facility') || request()->is('team') || request()->is('callToAction') || request()->is('appointment') || request()->is('testimonial') || request()->is('error') ? 'active' : '' }}" data-bs-toggle="dropdown">Pages</a>
